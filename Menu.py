"""
   This module returns the menu items when called by the function...
"""
from datetime import datetime
# List of items that are predefined...
...
# Prints the list of food menu, when the function is called...
def menu():
...
# Prints the list of beverages menu, when the function is called...
def beverages():
